...
const hostUrl = 'http://111.2.25.208:6081';//  正式
// const hostUrl = 'http://111.2.25.208:6181';//  測試
// const hostUrl = 'http://192.168.2.112:8085'
var $dialog={
    confirm: Confirm,
    alert: Alert,
    toast: Toast,
    ...
    let promise = new Promise((resolve,reject)=>{
      $.ajax({
        ...
        processData,
          ...
          //               request.setRequestHeader("Authorization","eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJ4bTAwMSIsImlhdCI6MTUzNzk0MzY2NCwic3ViIjoiMzNlYmJhNzBmMzQ3NDQ0YWIzNTQzNDhjOGNjMDhiZjIiLCJleHAiOjE1MzgwMzAwNjR9.hNneE5LH2tUZKUTPMgL-PsiYMJ1zB2iAwRWmwYlEdQ8");
          //  },
          // xhrFields: {withCredentials: true},
          // crossDomain: true,
        //   headers:{
